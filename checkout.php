...
<body>
   ...
   <?php include 'components/user_loggedin_header.php'; ?>
      ...
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="number" name="number" placeholder="enter your number" class="box" min="0" max="99999999999"
            ...
            <div class="inputBox">
               <span>pin code :</span>
               <input type="number" min="0" name="pin_code" placeholder="e.g. 1234" min="0" max="999999"
